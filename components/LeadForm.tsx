  ...
  if (completed) {
    return (
      <div className="bg-white rounded-2xl shadow-2xl shadow-navy-900/10 border border-slate-100 p-6 md:p-8 relative z-10 text-center min-h-[460px] flex flex-col items-center justify-center animate-in fade-in duration-700">
        ...
        <h3 className="text-2xl font-serif text-navy-900 font-bold mb-3">Quote Request Received!</h3>
        <p className="text-slate-500 mb-6">We are analyzing 15+ carriers for the best rates in <strong>{formData.zipCode || 'your area'}</strong>.</p>
        <p className="text-sm text-slate-400 bg-slate-50 px-4 py-2 rounded-lg">An agent will contact you shortly at <span className="text-navy-900 font-medium">{formData.email}</span>.</p>
        <button 
  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl shadow-navy-900/10 border border-slate-100 relative z-10 overflow-hidden">
        ...
        <div className="bg-navy-900 p-5 md:p-6 text-center relative overflow-hidden">
            ...
            <h3 className="text-xl md:text-2xl font-serif text-white tracking-tight mb-1 relative z-10">See How Much You Can Save</h3>
            <p className="text-sm text-slate-300 relative z-10">Compare 15+ top providers instantly.</p>
        </div>
        ...
        <div className="p-5 md:p-8">
            <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                        <label className="text-xs font-bold text-slate-700 uppercase tracking-wider ml-1">Current Insurer</label>
                        <div className="relative group">
                            <select 
                                required
                                name="currentInsurer"
